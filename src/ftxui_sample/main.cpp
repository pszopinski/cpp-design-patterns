...
// configuration step. It creates a namespace called `cpp_design_patterns`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_design_patterns::cmake::project_name, cpp_design_patterns::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_design_patterns::cmake::project_version);
      return EXIT_SUCCESS;
    }
